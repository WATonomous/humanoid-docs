...
```{note}
Each motor has an XT30 connector for CAN data. Power is supplied separately via XT60 (high-voltage motors) or XT30 (low-voltage motors). See [Electrical Documentation](../electrical/index.md) for details.
```

See [Electrical Documentation](../electrical/index.md) for detailed wiring diagrams.
...
- [Electrical wiring diagram](../electrical/index.md)
- [Motor selection](../mechanical/index.md)
